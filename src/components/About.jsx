      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="text-center mb-12 md:mb-16 lg:mb-24">
          <div className="inline-block px-4 py-2 mb-6 bg-black/10 dark:bg-white/10 border border-black/30 dark:border-white/30 rounded-full">
            <span className="text-xs md:text-sm text-black dark:text-white font-semibold uppercase tracking-wider">About Me</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="space-y-6 md:space-y-8">
            <div>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-800 dark:text-gray-200 leading-relaxed font-light">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6 mt-8 md:mt-12">
              <div className="stat-card group relative bg-white/80 dark:bg-white/5 backdrop-blur-2xl border border-gray-200 dark:border-gray-800 rounded-3xl p-6 md:p-8 text-center transition-all duration-500 hover:border-black dark:hover:border-white hover:scale-105 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  <div className="stat-number font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-black dark:text-white mb-2" data-target="25">0</div>
                  <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400 uppercase tracking-wider font-medium">Projects</div>
                </div>
              </div>
              <div className="stat-card group relative bg-white/80 dark:bg-white/5 backdrop-blur-2xl border border-gray-200 dark:border-gray-800 rounded-3xl p-6 md:p-8 text-center transition-all duration-500 hover:border-black dark:hover:border-white hover:scale-105 hover:-translate-y-2 hover:shadow-2xl">
                <div className="absolute inset-0 bg-black/0 dark:bg-white/0 group-hover:bg-black/5 dark:group-hover:bg-white/10 rounded-3xl transition-all duration-500"></div>
          ...
          <div className="relative h-64 sm:h-80 md:h-96 lg:h-[500px] xl:h-[600px]">
            <div className="absolute inset-0 rounded-3xl overflow-hidden">
              <div className="absolute inset-0 bg-black/10 dark:bg-white/10 animate-pulse-slow"></div>
              <div className="absolute inset-0 opacity-20" style={{
                backgroundImage: 'linear-gradient(rgba(99,102,241,0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(99,102,241,0.1) 1px, transparent 1px)',
                backgroundSize: '50px 50px'
              }}></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-24 h-24 md:w-32 md:h-32 lg:w-48 lg:h-48 rounded-full bg-gradient-to-br from-primary to-secondary animate-spin-slow opacity-30 blur-3xl"></div>
              </div>
            </div>
          </div>
        </div>
